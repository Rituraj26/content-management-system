                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        @foreach ($tasks as $task)
                            ...
                            @else
                                <div class="border-left border-bottom d-flex justify-content-between align-items-center p-3">
                                    <div class="h5 mb-0">{{ $task->title }}</div>
                                    <div class="d-flex align-items-center h5 mb-0">
                                        <span class="px-3 py-2 text-light badge bg-info mr-2">{{ $task->priorityList->name }}</span>
